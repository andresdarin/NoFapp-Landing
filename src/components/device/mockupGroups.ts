...
export const mockupGroups: Record<string, PlatformGroup> = {
  ...
  daily: { platform: "samsung", screens: [productScreens.home] },
  calendar: { platform: "mixed", screens: [productScreens.calendar, productScreens.home] },
  ...
  platforms: { platform: "mixed", screens: [productScreens.profile, productScreens.home] },
